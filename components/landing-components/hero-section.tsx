                ...
                <div className="flex-1 flex items-center justify-center pt-24 pb-8">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            >
                                <p className="text-lg text-landing-text-secondary mb-8 leading-relaxed max-w-2xl mx-auto">
                                    {subtitle}
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                    ...
                                    <Button className="px-6 py-3 bg-landing-primary-600 hover:bg-landing-primary-700 text-white">
                                        Sign up
                                    </Button>
                                </div>
                            </motion.div>
