...
export default function OnboardingPage() {
  ...
  const handleUserOnboardingComplete = async (responses: {
    ...
    if (!session?.user?.id) {
      toast.error(t('pages.onboarding.userNotFound'));
      return;
    }
    ...
    try {
      ...
      toast.error(t('pages.onboarding.errorSavingUserOnboarding'));
    }
  };

  const handleSocialOnboardingComplete = async (profileDescription: string) => {
    if (!socialAccountId) {
      toast.error(t('pages.onboarding.accountNotFound'));
      return;
    }
    ...
    try {
      ...
      toast.success(t('pages.onboarding.profileSetupCompleted'));
      ...
      toast.error(t('pages.onboarding.errorSavingSocialOnboarding'));
    }
  };
